...
console.log('The second item in the array is:' , supplyChanges);
...
console.log('Removed last value from:' , removedItem);
console.log('Updated the supplyChanges array:' , supplyChanges);

// 5. A delivery of 25 more parts arrived. Add the value 25 to the end of the array
console.log('5. Add the value 25 into supplyChanges.');
supplyChanges.push(25);
console.log('Added 25 more parts, supplyChanges is now:' , supplyChanges);
...
let = stretchPositives = [ ], stretchNegatives = [ ], this.stretchZeroes = [ ];
...
console.log('Positive values:' , stretchPositives);
console.log('Negative values:' , stretchNegatives);
console.log('Zero values:' , stretchZeroes); 
...
console.log('Boxes that are filled:' , boxesFilled);
